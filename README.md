...
The next force move is physical, not illustrative: build one representative tile from each family in both independent mode lineages; close mass, output, wet custody, containment, maintenance and hazard behavior; install structural saddle articles; then assemble and destroy representative survivor quorums at complete receivers. The 0.431-hour terrain clock margin, 1-hour terrain reset margin and industrial-independence claim are the immediate stop conditions. Exterior concept art remains blocked.
