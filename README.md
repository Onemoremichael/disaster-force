...
Pass 54 now freezes that successor before execution. Atomic posterior `v3C0` crosses four measurement likelihoods with three lawful state priors, keeps all twelve cases separate, fixes 1,152 chains and a 57.6-million-transition ceiling, and requires twenty-five co-governing gates plus independent reproduction. It deliberately creates zero posterior states: preregistration is a statistical constitution, not an executed model. Donor fitting and every downstream outcome remain sealed. The [active frontier](research/frontier.md) records this decision and the next admissible work. The [New York campaign dossier](research/proving/campaigns/new-york/README.md) holds the ordered evidence chain.
