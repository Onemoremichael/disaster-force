...
A third engine resolves that linear moment problem but fails at the nonlinear boundary. Pass 52 now registers the support the successor must use: 596 person cells, 960 occupied household-unit cells and one vacant-unit cell per catchment. Exact integer witnesses reconstruct all 456 published margins, but the 1,557-column aggregation operator has rank 32 and nullity 1,525. None of nine tested operational joints is point-identified in any catchment, and four impossible states pass every prior aggregate rule before the atomic semantics reject them. Feasibility is therefore established; a probability distribution is not. The next engine must calibrate a distribution over feasible atomic states, add authoritative under-five age detail and preserve the full moment and ceiling regime. Donor fitting and every downstream outcome remain sealed. The [active frontier](research/frontier.md) records this decision and the next admissible work. The [New York campaign dossier](research/proving/campaigns/new-york/README.md) holds the ordered evidence chain.
