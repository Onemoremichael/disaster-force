...
The active New York replication has been deliberately stopped before outcome modeling. Its first geographic rehearsal produced a citywide candidate universe, then exposed deficiencies in street topology, demographic completion, holdout custody and independent reproduction. The refusal to run a biased contest is itself a design result: **evidence custody and geographic validity are force infrastructure**.
