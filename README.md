...
This repository develops a first-principles answer: a cabinet-level **Department of Resilience** with operating services, commands, professions, laboratories, proving grounds, bases, depots, an industrial mobilization system and a purpose-built force.
...
The mature institution is therefore not a larger emergency-management coordinator. It is a standing force-generation system coupled to local continuity, hazard control, utility restoration, service projection and civil mobility. It must remain useful between catastrophes, survive common-mode failure, regenerate after employment and learn through an evidence enterprise with the power to reject favored designs.
...
The active New York replication remains deliberately stopped before outcome modeling. Its first geographic rehearsal exposed deficiencies in street topology, demographic completion, holdout custody and independent reproduction. The first correction now replaces polygon contact with the official `LION 26b` node-and-level graph: the candidate universe changes from 844 to 847, but all twelve disclosed references and all three commitments remain unchanged across primary, strict and permissive topology screens. Independent reproduction, demographic completion, salted custody and empty-table registration still block the contest. The refusal to run a biased comparison is itself a design result: **evidence custody and geographic validity are force infrastructure**.
...
For the integrated argument, read the [strategic study](research/synthesis/strategic-study.md). To interrogate how the answer is built, use the [research architecture](research/README.md): mandate → force → mission systems → proving. To inspect the live falsification frontier, begin with the [New York vertical heat-blackout protocol](research/proving/campaigns/new-york-vertical-heat-blackout-replication-protocol.md), its [`L0` catchment rehearsal](research/proving/campaigns/new-york-l0-catchment-rehearsal.md) and the [street-topology correction](research/proving/campaigns/new-york-l0-street-topology-audit.md).
