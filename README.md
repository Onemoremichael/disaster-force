...
The shortest route to the operating design is [force architecture](research/force/force-architecture.md) → [formation registry](research/force/generation/national-formation-registry.md) → [joint force allocation](research/force/generation/joint-force-allocation-and-order-of-battle.md) → [mission systems](research/systems/README.md).
