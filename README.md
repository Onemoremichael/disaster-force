...
The shortest route to the operating design is [force architecture](research/force/force-architecture.md) → [formation registry](research/force/generation/national-formation-registry.md) → [canonical allocation](research/force/generation/canonical-force-allocation-and-fiscal-reconciliation.md) → [projection](research/force/projection/README.md) → [mission systems](research/systems/README.md).
