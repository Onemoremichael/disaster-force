...
| Independent evidence | `MESA-1 / MESA-1R` | a physically separate, self-powered shadow formation can falsify mechanism, boundary effect and civil release while accounting for its own mass, heat, storage and terrain disturbance |
...
The next force move is physical, not illustrative: compete supplier-neutral MESA-1R cassette, carrier-node, pressure-skin, receiver and one-way-interface architectures; freeze serial prototypes; execute the eight P01–P08 campaigns; and only then assemble and destroy representative survivor quorums at complete receivers. The 0.431-hour terrain clock margin, 1-hour terrain reset margin, 0.366-kPa instrumented pressure margin, evidence-system equivalence and industrial-independence claim are immediate stop conditions. Exterior and internal concept art remain blocked.
