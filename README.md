...
The institutional scale is now explicit. AIMC governs a continuous three-root acquisition portfolio, twelve technology frontiers, a public evidence and reproduction commons, six paid industrial-readiness states and twenty-four stop gates. The next force-generation pass must define the common program-office operating system: requirement custody, root ancestry, earned physical artifacts, serial configuration, technical data, cost uncertainty, mobilization contracts, failure replacement and the transactions among the seven separated authorities. The 0.431-hour terrain clock margin, 1-hour terrain reset margin, 0.366-kPa instrumented pressure margin, evidence-system equivalence and industrial-independence claim remain immediate physical stop conditions. Exterior and internal concept art remain blocked until weighed, scanned, calorimeter-tested and removal-equivalent articles exist.
