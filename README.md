...
| Independent evidence | `MESA-1 / MESA-1R / MESA-1C / MESA-1D` | a physically separate, self-powered shadow formation can falsify mechanism, boundary effect and civil release through supplier-neutral architectures, build-release packages, protected articles and frozen trials while accounting for its own mass, heat, storage and terrain disturbance |
...
The current proving pass now specifies the measurement force beneath that institution. [CSAC-1](research/force/projection/csac1-compound-service-article-and-range-campaign.md) creates the campaigns, ranges and Service Systems Proving Command. [MESA-1](research/force/projection/mesa1-measurement-and-destructive-evidence-architecture.md) establishes separate embedded-control, independent-mechanism and civil-effect planes; [MESA-1R](research/force/projection/mesa1r-representative-evidence-hardware-and-hazard-envelope.md) turns the independent planes into physical hardware. [MESA-1C](research/force/projection/mesa1c-supplier-neutral-architecture-and-trial-constitution.md) competes thirty-three architectures and selects eleven prototype baselines. [MESA-1D](research/force/projection/mesa1d-prototype-build-release-and-acceptance-standard.md) now makes those selections buildable through 154 controlled release records, 132 article acceptances, eighty-eight hazard exposures, twenty-three calibration chains and ninety-six sub-tier rights records. It corrects the calendar: the seventy-eight-month P01–P08 sequence follows a twenty-four-month build-release lead, so complete evidence moves to month 102. The USD 6.8B campaign remains nested inside F01's USD 24B and the USD 1.050T proving portfolio. Every physical gate remains open, production is on hold and renderings remain blocked.
...
The next force move is physical, not illustrative. MESA-1D now defines the common build-release and acceptance constitution; the next pass must turn it into family-specific procurement data packages and a source-selection experiment. Rival teams must expose decisive ancestry, build serialized engineering and qualification lots, reserve independent facilities and reproduce one another's accepted result before P08 can close. The 0.431-hour terrain clock margin, 1-hour terrain reset margin, 0.366-kPa instrumented pressure margin, evidence-system equivalence and industrial-independence claim remain immediate stop conditions. Exterior and internal concept art remain blocked until weighed, scanned, calorimeter-tested and removal-equivalent articles exist.
