...
| Independent evidence | `MESA-1 / MESA-1R / MESA-1C` | a physically separate, self-powered shadow formation can falsify mechanism, boundary effect and civil release through supplier-neutral architectures, protected articles and frozen trials while accounting for its own mass, heat, storage and terrain disturbance |
...
The next force move is physical, not illustrative: convert the eleven MESA-1C prototype baselines into build-release and acceptance packages, award rival teams below the prime-contractor level, freeze serial articles and begin P01–P08. The 0.431-hour terrain clock margin, 1-hour terrain reset margin, 0.366-kPa instrumented pressure margin, evidence-system equivalence and industrial-independence claim are immediate stop conditions. Exterior and internal concept art remain blocked until weighed, scanned, calorimeter-tested and removal-equivalent articles exist.
