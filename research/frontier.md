...
In parallel research terms—not in outcome access—the [canonical force architecture](force/force-architecture.md), [National Formation Registry](force/generation/national-formation-registry.md) and [canonical allocation](force/generation/canonical-force-allocation-and-fiscal-reconciliation.md) govern the Department-scale agenda. The next force-model pass should configure the dominant Household Collection Group unit of account and build an item-identified shared-capacity ledger before rebuilding strategic deployment around canonical cargo. None of that work may disturb the New York architecture firewall.
