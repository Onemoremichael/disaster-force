...
[Projection](projection/README.md) owns the origin-to-effect path for mobile capacity: strategic movement, damaged-theater entry, onward distribution, responder basing, sustainment, reverse flow and regeneration. Its canonical compiler reaches one formation-level serial register; the first-reach studies now convert one invalid source line into rival material, packing, machine, schedule, failure, receiver, federation and industrial requirements. Measured articles, serialized island and alternate-source bills of material, safe unknown-agent release doctrine, carrier routes and complete second-event missions remain the next proof boundary.
