...
[Projection](projection/README.md) owns the origin-to-effect path for mobile capacity: strategic movement, damaged-theater entry, onward distribution, responder basing, sustainment, reverse flow and regeneration. Its canonical compiler reaches one formation-level serial register; the first-reach study now converts one invalid source line into rival material, packing, machine, schedule, failure, receiver and industrial requirements. Measured articles, degraded-service architecture, carrier routes and complete receiver missions remain the next proof boundary.
