...
The next force-model pass should convert representative cargo into **carrier and node requirement envelopes**. It should identify the smallest set of rival platform families able to accept the position portfolio, generate 24/48/72-hour activation curves, distinguish road from rail, bind routes and origins, and carry arrivals through receiver commissioning. That pass should include clean-sheet technology alternatives but still resist premature exterior form.
