...
The resource scale is necessarily large. The first forty-eight-family successor contains 2,420 heterogeneous formation-equivalent commitments, 10.484 million affiliated billet-equivalents, $15.179 trillion in capital with reserve and $1.736 trillion in mature annual operations. It preserves the Pass 23 $12.049 trillion and 3.945 million baselines to arithmetic tolerance, adds $5.852 trillion of gross capital claims and deducts $2.722 trillion of visible shared-system credit. Those values are internally linked design hypotheses for a very high concurrency standard. They are not cost estimates, budget recommendations or values that can yet survive independent validation. Their immediate meaning is architectural: household collection, utility restoration, patient movement and complete civil continuity cannot be added to the mission while their people, equipment and entry requirements remain off the books.
