...
The [National Formation Registry](../force/generation/national-formation-registry.md) now makes that structure auditable. It identifies forty-eight canonical family hypotheses but finds distinct quantitative lines for only thirty-three. The thirty-fourth Pass 23 line is a legacy utility aggregate that must be disassembled into water, power and grid-bridge formations without duplicating cost or workforce. Fifteen canonical families—including all seven Civil Mobility and Continuity families—therefore remain outside the national concurrency model. Eight families have configuration-level proxies, none has reached representative `R3` evidence, and no family has configuration-grade closure for dependencies, sustainment and waste, authority and transfer, or regeneration.
