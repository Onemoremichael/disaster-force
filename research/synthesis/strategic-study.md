...
12. Twenty evidence gates remain open. The first item-level campaign model should be Cascadia and should trace configuration-controlled people and cargo from home station through independent paths, queues, damaged structures, responder bases, 90-day sustainment, reverse flow and reconstitution. Rendering remains blocked.
