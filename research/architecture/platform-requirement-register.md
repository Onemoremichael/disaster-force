...
Passes 27–29 add the first force-level configuration family. These entries govern what transport and utility platforms must carry; they are not vehicles themselves.
...
| SEC-PCC45 | Configured Independent Service Entry Cell | Admitted problem | Project three configured `PCC-50`-bearing pods without host utilities | 45,458.58 t/cell; worst N-2 case delivers eight pods by h72 and tenth at h84.02; target ≤36,146.25 t/cell for the air ceiling | close ≤11,818.20-t technology case or increase/preposition movement and receiving capacity | R2+ |
