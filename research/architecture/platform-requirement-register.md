...
| NRL | National Receiving Lattice | Admitted reference | Convert fixed sites, surviving buildings and local stocks into maintained, hazard-independent receiving capacity for mobile service formations | Four classes; 7,200 domestic nominal CDE; 3,707 N-2/common-mode assured CDE; 72.1% fixed share; 11,612.76-t pod; tenth cargo h70.05; clustered damaged-region shortfall 878 CDE; $563.808B capital hypothesis | real catchments and parcels; joint hazard/route covariance; receiver-transfer timing; structural and utility reference designs; occupied activation trials; workforce and independent cost; eighteen open gates | R1/R2 with R2+ arithmetic |
...
The immediate cross-cutting gate is now geographic allocation under correlated receiver and route damage. The balanced National Receiving Lattice restores aggregate hour-72 movement with a 72.1-percent fixed occupied-area share, but its synthetic clustered damaged-region case supplies only 1,621.94 of 2,500 required CDE. The next pass must compare a denser local lattice with time-proved interregional transfer, greater mobile substitution and lawful population relocation on a population-weighted multimodal network. Parallel district technology must continue reducing mass, volume, labor and commissioning time. Vehicle and receiver geometry remains provisional.
