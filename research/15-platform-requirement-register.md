...
| FIN | Flood Intercept Network | Admitted reference | Act before a location-specific water, access or structural threshold | distributed forecast/detection, inspection, closures, tactical pumps, barriers, rescue and escalation; complete action clock governs | correlated forecast/action distributions, geographic posture, local interfaces, false confidence, simultaneous watches and readiness | R2 |
| HCG-100 | Hydraulic Control Group 100 reference formation | Admitted reference | Deliver complete regional water control, access and recovery | 100 m³/s installed portfolio; 75M m³ trapped-basin screen with 75% utilization and 20 m³/s inflow gives 15.8 d ideal drawdown; 17.95 MW at 15 m head before added losses; inland and coastal modules | time-indexed cases, pump curves, intakes, routes, receiving water, barriers, breach, access, contamination, manifest, workforce, readiness and cost | R2 |
...
6. **FIN and HCG-100:** build the 29-sheet inland/coastal configuration; close storage, head/flow, intake, power, drainage spine, receiving water, barrier/interior drainage, breach, rescue, contamination, movement, workforce and concurrency before drawing pumps, craft, barriers or works carriers.
