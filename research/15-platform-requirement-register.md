...
| HCG-100 | Hydraulic Control Group 100 reference formation | Admitted reference | Deliver complete regional water control, access and recovery | inland urban screen: 100 m³/s nominal becomes 36.551 m³/s effective, +16.051 m³/s day-zero removal, 28 d drawdown, −14.01 m³/s interior margin, 79,391 t dry and 7,039 deployed / 26,394 billets; coastal/inland variants tested across five cases | calibrated hydrographs and action distributions; full pump/intake curves; route transients; receiving stage; barrier, interior drainage and breach trials; amphibious, environmental, item-manifest, workforce, readiness, lifecycle and complete-thread evidence | R2+ |
...
6. **FIN and HCG-100:** replace the 29-sheet configuration's highest-leverage assumptions with empirical evidence, beginning with correlated action tails, full-curve pump/intake availability, drainage-spine mass/setup/transients, dedicated interior drainage, live-flow breach reduction and amphibious operating envelopes; no pump, craft, barrier, robot or works-carrier drawing precedes R3 closure.
