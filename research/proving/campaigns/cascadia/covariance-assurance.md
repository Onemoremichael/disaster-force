...
The accompanying [covariance and assurance workbook](../../../../models/proving/campaigns/cascadia/cascadia-covariance-model.xlsx) exposes all assumptions, fixed random draws, latent states, closure formulas, finance deltas, sources and open evidence gates.
