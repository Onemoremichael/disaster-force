...
This study replaces that aggregate screen with an item-level Cascadia campaign. The linked [Cascadia campaign model](../../../../models/proving/campaigns/cascadia/cascadia-campaign-model.xlsx) resolves:
