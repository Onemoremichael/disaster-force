...
No generated state exists. The next gate is implementation and independent reproduction of the public-class compiler, including acquisition and frozen transformation of the PUMS donor files and construction of the target covariance cases. Formal `L0` still requires external salted holdout custody, operational building and medical-power evidence or bounded unknown-state treatment approved for the test, service-territory authority, causal feasibility, alternative dependence cases and independent reconstruction of the earlier New York lineage.
