...
The [moment-reconciliation successor](l0-moment-reconciliation-engine.md) proves that the published covariance blocks, marginal standard errors and exact additive identities can coexist, eliminating every interior spread failure. Its Gaussian states nevertheless violate nonnegativity or subset relations in roughly half of raw rows; one-sided repair shifts centers and tails. The next admissible pass is therefore a latent atomic-cell engine, not donor fitting. Architecture access remains prohibited.
