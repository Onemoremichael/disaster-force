...
[Force](force/README.md) converts the obligation into echelons, professions, formations, commands, bases, stocks, mobility, reception, readiness and regeneration. Its central object is an effect-complete formation, not an equipment inventory. Force design can close a campaign on declared assumptions; it cannot turn uncertain rates into evidence.
...
To understand the mature operating system, read [mature force design](force/generation/mature-force-design.md), [force composition](force/generation/force-composition.md), the [mission-system architecture](systems/README.md) and the [joint force allocation](force/generation/joint-force-allocation-and-order-of-battle.md).
