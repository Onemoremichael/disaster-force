...
To understand the mature operating system, read the [Department force architecture](force/force-architecture.md), the [mission-system architecture](systems/README.md) and the [joint force allocation](force/generation/joint-force-allocation-and-order-of-battle.md). The force-generation index routes to deeper composition, readiness and unit-design papers without making the landing page an inventory.
