...
To understand the mature operating system, read the [Department force architecture](force/force-architecture.md), the [National Formation Registry](force/generation/national-formation-registry.md), the [joint force allocation](force/generation/joint-force-allocation-and-order-of-battle.md) and the [mission-system architecture](systems/README.md). The force-generation index routes to deeper composition, readiness and unit-design papers without making the landing page an inventory.
