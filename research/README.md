...
To understand the mature operating system, read the [Department force architecture](force/force-architecture.md), the [National Formation Registry](force/generation/national-formation-registry.md), the [canonical allocation](force/generation/canonical-force-allocation-and-fiscal-reconciliation.md) and the [mission-system architecture](systems/README.md). The Pass 23 [joint force allocation](force/generation/joint-force-allocation-and-order-of-battle.md) remains the predecessor and lineage control.
