...
The editable workbook is [`disaster-force-model.xlsx`](../../models/programmatics/disaster-force-model.xlsx).
...
This workbook preserves the project's first Department-wide scale screen. It is still useful for sensitivities and for the original $1T-versus-$2.24T contradiction, but it is no longer the authoritative force-generated order of battle. Pass 23's [joint force allocation study](../force/generation/joint-force-allocation-and-order-of-battle.md) created the first formation-level predecessor; Pass 58's [canonical allocation](../force/generation/canonical-force-allocation-and-fiscal-reconciliation.md) now carries all forty-eight registered families, explicit shared-capacity credits and the current national resource contradictions.
